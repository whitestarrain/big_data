...
<center><img src="./img/pokeman-parameters.png" alt="pokeman-parameters" style="width:60%;"/></center>
#### Regression的具体过程
...
<center><img src="./img/model.png" alt="model" style="width:60%;" /></center>
...
<center><img src="./img/goodness-of-function.png" alt="goodness-of-function" style="width:60%;" /></center>
###### Loss function 损失函数
...
<center><img src="./img/loss-function.png" alt="loss-function" style="width:60%;" /></center>
###### Loss function可视化
...
<center><img src="./img/loss-figure.png" alt="loss-figure" style="width:60%;" /></center>
...
<center><img src="./img/best-function.png" alt="best-function" style="width:60%;" /></center>
...
* 因此每次参数更新的大小是 $η \frac{dL}{dw}$，为了满足斜率为负时w变大，斜率为正时w变小，应当使原来的w减去更新的数值，即
    ...
    <center><img src="./img/gradient-descent.png" alt="gradient-descent" style="width:60%;" /></center>
...
<center><img src="./img/gradient-two-parameters.png" alt="gradient-two-parameters" style="width: 60%;" /></center>
##### Gradient Descent的缺点
...
<center><img src="./img/gradient-stuck.png" alt="gradient-stuck" style="width:60%;" /></center>
...
<center><img src="./img/results.png" alt="results" style="width:60%;" /></center>
...
<center><img src="./img/Xcp-2.png" alt="Xcp-2" style="width:50%;" /></center>
###### 考虑$(x_{cp})^3$的model

<center><img src="./img/Xcp-3.png" alt="Xcp-3" style="width:50%;" /></center>
###### 考虑$(x_{cp})^4$的model

<center><img src="./img/Xcp-4.png" alt="Xcp-4" style="width:50%;" /></center>
###### 考虑$(x_{cp})^5$的model

<center><img src="./img/Xcp-5.png" alt="Xcp-5" style="width:50%;" /></center>
###### 5个model的对比
...
<center><img src="./img/Xcp-compare.png" alt="compare" style="width:60%;" /></center>
...
<center><img src="./img/Xcp-overfitting.png" alt="overfitting" style="width:60%;" /></center>
...
<center><img src="./img/hidden-factors.png" alt="hidden-factors" style="width:60%;" /></center>
因此我们重新设计model：
...
<center><img src="./img/new-model.png" alt="new-model" style="width:60%;" /></center>
有了上面这个model以后，我们分别得到了在training data和testing data上测试的结果：

<center><img src="./img/new-results.png" alt="new-results" style="width:60%;" /></center>
...
<center><img src="./img/regularization.png" alt="regularization" style="width:60%;" /></center>
...
<center><img src="./img/regularization-performance.png" alt="regularization-performance" style="width:60%;" /></center>
#### conclusion总结
...
<center><img src="./img/L1L2regularization.png" alt="regularization"  /></center>
...
<center><img src="./img/L1-L2.png" alt="L1-L2"  /></center>
